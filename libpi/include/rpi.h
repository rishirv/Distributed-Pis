...
#define AUX_IO_REG 0x20215040
#define AUX_IER_REG 0x20215044
#define AUX_IIR_REG 0x20215048
#define AUX_CNTL_REG 0x20215060
#define AUX_LCR_REG 0x2021504C
#define AUX_STAT_REG 0x20215064
#define AUX_BAUD_REG 0x20215068
/*****************************************************************************
 * output routines.
 */
...
// delay for <us> microsecond FOR USE IN THREADS ONLY, calls rpi_yield instead of nop. 
void delay_us_th(unsigned us);
