...
// internal routine 
void c_enter(uint32_t *new_sp);

void start_scheduler_th(uint32_t* sched_sp);
...
void rpi_halfswitch(uint32_t* sp);

void rpi_enter(uint32_t* sp);
void rpi_enter2(uint32_t* sp);

void rpi_cswitch2(uint32_t* oldsp,uint32_t * newsp);
